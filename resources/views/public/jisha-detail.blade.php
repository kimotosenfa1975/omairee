<x-guest-layout>
    ...
    <div class="main">
        <div class="jisha-wrapper jisha-detail">
          ...
          <div class="section">
            <a href="{{route('mypage.ema')}}" class="red">絵馬を見に行く</a>
          </div>
          ...
          <div class="section gift-btn-group">
            <a href="#omikuji-modal" class="red">コインを購入する</a>
            <a  class="outline-red">お参りする</a>
          </div>
          <div class="page-sub-title">利用規約、プライバシーポリシーに同意の上ご利用ください</div>
        </div>
    </div>

    <div class="modal-container jisha-detail" id="omikuji-modal">
        <div class="modal">
            <img src="{{ asset('img/coin-gift.png') }}" class="omikuji" alt="" onclick="startOmikuji()">
