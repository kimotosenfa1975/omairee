...
Route::get('/{jisha}/jisha-detail', [App\Http\Controllers\Pub\CompanyController::class, 'detail'])->name('pub.jisha-detail');
Route::post('/toPray', [App\Http\Controllers\Pub\CompanyController::class, 'toPray'])->name('pub.toPray');
...
Route::name('mypage.')->middleware(['auth'])->group(function () {
    ...
    Route::post('/buyCoin',[App\Http\Controllers\Mypage\MypageController::class, 'stripePost'])->name('buyCoin');
    
    Route::get('/omikuji', [App\Http\Controllers\Pub\OmikujiController::class, 'index'])->name('omikuji');
    Route::post('/getOmikuji', [App\Http\Controllers\Pub\OmikujiController::class, 'endData'])->name('end');
    Route::get('/ema', [App\Http\Controllers\Pub\EmaController::class, 'index'])->name('ema');
    Route::get('/ema-register',[App\Http\Controllers\Pub\EmaController::class, 'emaRegisterShow'])->name('ema-register-show');
    ...
    Route::post('/updateJishaInfo', [App\Http\Controllers\Mypage\JishaController::class, 'updateJishaInfo'])->name('updateJishaInfo');
    Route::post('/updateJishaBank', [App\Http\Controllers\Mypage\JishaController::class, 'updateJishaBank'])->name('updateJishaBank');
